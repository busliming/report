 ...
 * @LastEditors: Nice
 * @LastEditTime: 2020-08-12 15:25:36
 -->
<template>
  <div
        ...
        <div class="content">
          <div class="row pt20x">
            ...
            <div class="col-5 ml20x">
              ...
              <span class="text-panda-text-7">{{currentUser.adjustAmount | moneyFormat}}</span>
            </div>
          </div>
          <div class="row mt10x">
            <div class="col-2">
          ...
          <div class="row mt10x">
            <div class="col-12 row">
              ...
              <span class="text-panda-text-7">{{currentUser.adjustCause}}</span>
            </div>
          </div>
          <div class="row mt20x">
            <q-space></q-space>
          ...
          <div class="fee bg-panda-bg-6 border-radius-4px mt10x">
            ...
            <div class="text-panda-text-7 row text-center line-height-36px">
              ...
              <div class="w-150 text-left">
                <span class="ml50x">{{currentUser.orderPaymentAmount | amount}}</span>
              </div>
            </div>
            <div
            ...
            >
              ...
              <q-space></q-space>
              <div class="w-150 text-left">
                <span class="ml50x">{{currentUser.billAmount | moneyFormat}}</span>
              </div>
            </div>
          </div>
        </div>
