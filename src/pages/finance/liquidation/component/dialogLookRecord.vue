 ...
 * @LastEditors: Nice
 * @LastEditTime: 2020-06-09 22:05:45
 -->
<template>
  <div
        ...
        <div class="content">
          ...
          >
            <span slot="adjustAmountBefore" slot-scope="text, record">
              ...
              <!-- <span>执行费率：{{ record.executeRateBefore }}%</span> -->
            </span>
            <span slot="adjustAmount" slot-scope="text, record">
              <span>调整金额：{{ record.adjustAmount }}</span><br> 
              <!-- <span>执行费率：{{ record.executeRate }}%</span> -->
            </span>
...
export default {
  ...
  data() {
    return {
      ...
      userCurrencyColumns: updateRecordConfig,
      userCurrencyData: [],
      tableData: [],
      pagination: {
        pageSize: 10,
