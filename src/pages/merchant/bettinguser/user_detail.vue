<template>
  <div class="full-width full-height">
          ...
          <div class="col-4 text-center">
            ...
            <div class="mt30x">
              <div class="q-pr-sm">
                <span
                  class="fs20 fw_600"
                >￥{{profitObj&&profitObj.fourteenDay&&(profitObj.fourteenDay.profit/10000).toFixed(2)}}</span>万
              </div>
              <span>14天盈利</span>
            </div>
          </div>
          <div class="col-4 text-center">
            ...
            <div class="mt30x">
              <div class="q-pr-sm">
                <span
                  class="fs20 fw_600"
                >￥{{profitObj&&profitObj.threeMonth&&(profitObj.threeMonth.profit/10000).toFixed(2)}}</span>万
              </div>
              <span>3个月盈利</span>
            </div>
          </div>
          <div class="col-4 text-center">
            ...
            <div class="mt30x">
              <div class="q-pr-sm">
                <span
                  class="fs20 fw_600"
                >￥{{profitObj&&profitObj.sixMonth&&(profitObj.sixMonth.profit/10000).toFixed(2)}}</span>万
              </div>
              <span>6个月盈利</span>
            </div>
          </div>
    ...
    <q-dialog v-model="dialogMonthShow" persistent transition-show="scale" transition-hide="scale">
      <dialog-month :detailObj="showDetailObj" :betRows="betRows" @closeDialogSetShow='handleCloseDialogSet'></dialog-month>
    </q-dialog>
  </div>
</template>
