<template>
  <div class="full-width full-height">
            ...
            <div class="row">
              ...
              <div class="right ml80x" style="margin-top: 60px;">
                <div class="flex" style="width:165px; position: relative">
                  <div class="border-radius-4" :style="detailObj.logo? 'border: 1px dashed #c1c1c1': ''">
                    <img
                      :src="detailObjImg"
                      v-if="httpUrl_72"
            ...
            <div class="row">
              <div class="col-lg-3 col-md-2">
                <div class="pl40x">
                  ...
                  <div
                    class="append-handle-btn-input position-relative w-180"
                    id="commerce"
                  >
                    <a-form-item>
                      <a-select
                      ...
                      >
                        <a-select-option v-for="(item, index) in commerceList" :key="index" :value="item.name">{{item.name}}</a-select-option>
                      </a-select>
                    </a-form-item>
    ...
    <q-dialog v-model="selectLevelShow" persistent transition-show="scale" transition-hide="scale">
      <dialog-select-level @closeSelectDialog="handleCloseDialogSelect"></dialog-select-level>
    </q-dialog>
  </div>
</template>
