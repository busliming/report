<template>
  <div class="full-width full-height">
    ...
    <div style="margin: 20px; min-height: 790px;" class="bg-panda-bg-6 shadow-3 border-radius-4 pl20x pr20x">
              ...
              <div class="col-lg-6 col-md-12">
                  ...
                  <div class="left mt20x pl40x">
                    ...
                    <div class="w-240">
                      <div class="text-panda-text-7 ">
                        <div class="flex justify-between mb10x">
                ...
                <div class="flex ml40x" v-for="(item, index) in users" :key="'contact' + index">
                  <div :key="'contact' + index">
                    <div class="text-panda-text-7  fw_600  mb10x" v-if="index == 0">
                      商务联系人
                      <span class="panda-text-red">*</span>
                    </div>
                    <div class="append-handle-btn-input row">
                ...
                <div class="flex ml40x mt10x">
                  <div class>
                    <div class="text-panda-text-7  fw_600 mb10x">国家</div>
                    <div class="append-handle-btn-input row">
...
export default {
  ...
  beforeCreate() {
    this.form = this.$form.createForm(this, { name: "channelEdit" });
  },
  created() {
