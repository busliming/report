 ...
 * @LastEditors: Nice
 * @LastEditTime: 2020-04-19 10:29:40
 -->
<template>
  <div
    style="width: 582px; height:auto;max-width:582px; overflow:hidden;"
      ...
      >
        ...
        <template slot="footer">
          <div class="flex justify-between fw_600 text-panda-text-7 text-left" style="padding: 0;margin: 0">
            <div style="width: 98px; text-align: center;">总计</div>
            <div style="width: 110px;">{{betTodayData[0].betAmount | amount}}</div>
            <div style="width: 110px;">{{betTodayData[0].settleAmount | amount}}</div>
            <div style="width: 110px;">{{betTodayData[0].profit | amount}}</div>
            <div style="width: 122px;">{{betTodayData[0].betNum | amount}}</div>
          </div>
        </template>
      </a-table>
    </q-card>
