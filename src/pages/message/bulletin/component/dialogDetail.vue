 ...
 * @LastEditors: Nice
 * @LastEditTime: 2020-06-28 20:41:02
 -->
<template>
  <div
    style="width: 1144px ; height:auto;max-width:1144px; overflow: hidden"
      ...
      <div class="content">
        <div class="top text-center mt20x pb40x">
          <div class="title text-panda-text-7 fw_600">
            ...
            <span class="auto-wrap">{{currentUser.title}}</span>
          </div>
        ...
        <div class="line-height-30px flex mt30x">
          ...
          <div class="text-right text-panda-text-4 fs12">
            <div class="fs14">{{currentUser.createdBy?currentUser.createdBy: 'Panda'}}</div>
...
export default {
  ...
  methods: {
    ...
    async initBulletinDetail() {
      ...
      let res = await api_message.post_admin_noticeNew_noticeDetail(params);
