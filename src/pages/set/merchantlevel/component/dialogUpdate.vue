 ...
 * @LastEditors: Nice
 * @LastEditTime: 2020-06-07 16:08:49
 -->
<template>
    ...
    handleSubmit(e) {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          // delete values.terraceRate;
          // delete values.computingStandard;
          // delete values.paymentCycle;
