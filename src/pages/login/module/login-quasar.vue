<template>
  <div class="login" :class="showMsg? 'off': 'on'" @keyup.enter="onSubmit" @click="showhide">
    <div class="absolute-center" id="login-common">
      <div class="text-center" style="padding-top: 40px;">
        <img src="~assets/logo.svg" height="80px" alt srcset />
      </div>
      <div class="text-center login-title mt30x mb40x">熊猫后台权限账号平台</div>
      ...
      <div class="text-white row justify-center text-white mb40x fs12">
