...
//  HTTP 根域名： axios.defaults.baseURL
 ...
 * process.env.API_PREFIX_6:   ronghews
 *
 */

// axios.prototype.WS_DOMAIN_FRNGKONG_1= axios.prototype.WS_ROOT_DOMAIN+'/'+process.env.API_PREFIX_7+'/rcsWebSockets'
// axios.prototype.WS_DOMAIN_RONGHE_1=axios.prototype.WS_ROOT_DOMAIN+'/'+process.env.API_PREFIX_6+'/realData/'
...
axios.interceptors.request.use(
  config => {
    ...
    // token
    let language = SessionStorage.getItem('language') || 'zs'
