 ...
 * @LastEditors: Nice
 * @LastEditTime: 2020-08-27 16:02:48
 */
import Vue from "vue";
...
// import MyIcon from 'src/components/myIcon/myIcon.vue'

import { Button, Tree, Table, Menu, Icon, Layout, Col, Row, Dropdown, LocaleProvider, Tooltip, Progress, Tabs, Radio, DatePicker, Select, Upload, message, Badge, Popconfirm, Input, InputNumber, Form, Checkbox, Modal, Popover, List, Card } from 'ant-design-vue';

export const MyIcon = Icon.createFromIconfontCN({
  scriptUrl: '//at.alicdn.com/t/font_1635903_iu78w1t7kw.js', // 在 iconfont.cn 上生成
});
...
export default function (/* { store, ssrContext } */) {
  ...
  Router.beforeEach((to, from, next) => {
    ...
    if (to.path === '/login' || to.path === '/password' || to.path === '/newpassword' || to.path === '/browser' || to.path === '/maintain' || to.path === '/browsermac') {
      if (value) {
        // 白名单路由 在登录状态下重定向
        next('/main/home')
      } else {
